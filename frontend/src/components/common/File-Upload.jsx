...
export const FileUpload = ({
  ...
  const [isUploaded, setIsUploaded] = useState(false);    // Track upload completion
  ...
  const handleUploadImage = () => {
    if (files.length > 0) {
      // Simulate uploading with a delay (you can replace this with actual upload logic)
      setIsUploading(true);
      setIsUploaded(false);

      // Simulate an API upload request (this is just a placeholder, replace with real logic)
      setTimeout(() => {
